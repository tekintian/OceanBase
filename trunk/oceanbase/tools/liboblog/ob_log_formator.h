  ...
  namespace liboblog
  {
    ...
    class ObLogDenseFormator : public IObLogFormator
    {
      ...
      private:
        ...
        int format_dml_statement_(ObLogMutator &mutator,
            volatile bool &loop_stop,
        ...
        /// @brief Query back if needed based on ObLogDmlStmt
        /// @param[in] dml_stmt initialized DML statement: ObLogDmlStmt
        /// @param[out] query_back_col_value returned queried back column value
        /// @retval OB_SUCCESS on success
        /// @retval OB_SCHEMA_ERROR when schema is invalid and should be updated.
        /// @retval OB_INVALID_DATA when source data is invalid
        /// @retval other error state on error
        ...
        int query_back_if_needed_(ObLogDmlStmt *dml_stmt, const IObLogColValue *&query_back_col_value);
        ...
        /// @param[in] query_back_col_value queried back column value
        /// @retval OB_SUCCESS on success
        /// @retval ! OB_SUCCESS on fail
        ...
        /// @param query_back_col_value queried back column value
        /// @retval OB_SUCCESS on success
        /// @retval ! OB_SUCCESS on fail
        ...
        /// @brief Fill queried back column value into RowValue
        /// @param row_value target RowValue
        /// @param query_back_col_value queried back column value
        /// @retval OB_SUCCESS on success
        /// @retval ! OB_SUCCESS on fail
        int fill_row_value_query_back_col_value_(RowValue *row_value,
            const IObLogColValue *query_back_col_value);
